...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Convert Bool to Velocity configuration.lvclass" Type="LVClass" URL="../module/configuration/Convert Bool to Velocity configuration.lvclass"/>
		<Item Name="Convert Bool to Velocity editor node.lvclass" Type="LVClass" URL="../editor node/Convert Bool to Velocity editor node.lvclass"/>
		<Item Name="Convert Bool to Velocity runtime.lvclass" Type="LVClass" URL="../module/execution/Convert Bool to Velocity runtime.lvclass"/>
		<Item Name="Convert Bool to Velocity tests.lvlib" Type="Library" URL="../Test/Convert Bool to Velocity tests.lvlib"/>
